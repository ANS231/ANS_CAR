...
const HomeBanner = () => {
  const bannerData = {
    image: BannerImage,
    title:
      "Find the right <span class='block text-8xl leading-none tracking-tight'>Event <span class='text-magenta-500'>Planner</span></span>",
    subtitle: "to fit your party needs",
    description:
      "<p>Our event booking platform revolutionizes the way you plan and organize events. Whether you’re hosting a corporate conference, a music festival, a wedding, or any other type of gathering, our platform provides a seamless and efficient experience from start to finish.</p>",
    searchTitle: "Looking for car booking?",
  };
  const dropdownData = [
    {
      _id: 1,
      ...
      <section className="relative h-screen py-32 flex flex-col justify-center z-[1] bg-neutral-100">
        ...
        <div className="w-full px-4 sm:max-w-xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl 2xl:max-w-8xl 3xl:max-w-9xl mx-auto">
          <div className="w-1/2 space-y-4">
            <h1
              className="text-white text-5xl uppercase font-bold leading-none"
              dangerouslySetInnerHTML={{ __html: bannerData.title }}
            ></h1>
            <h3
              className="text-white text-4xl uppercase font-semibold leading-none"
          ...
          <div className="w-full px-4 sm:max-w-xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl 2xl:max-w-8xl 3xl:max-w-9xl mx-auto">
            <div className="w-3/4 rounded-lg mx-auto bg-white py-6 px-6 shadow-lg space-y-4">
              <h4
                ...
                dangerouslySetInnerHTML={{ __html: bannerData.searchTitle }}
              ></h4>
              <div className="flex items-center gap-10">
                ...
                <div class="relative">
                  <div className="absolute top-1/2 -left-10 flex items-center justify-center border-t border-l border-r border-b border-slate-300 w-20"></div>
                </div>
                <div className="w-1/2 flex-shrink">
                  <SearchWithDropdown
                    divClasses={"!border-slate-100 !bg-neutral-100"}
