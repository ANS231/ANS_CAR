  ...
  return (
    <>
      <Link href={data.link} className="w-full z-[1] group flex">
        <div className="relative overflow-hidden flex flex-col rounded-xl shadow w-full bg-neutral-50 border border-neutral-100 transition-all duration-300 group-hover:bg-magenta-100 group-hover:border-magenta-100 group-hover:shadow-xl">
