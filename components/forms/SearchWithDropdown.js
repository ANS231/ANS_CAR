      ...
      <div className="relative">
        ...
        >
          <div
            ...
            className={classNames(
              "relative flex h-12 w-full bg-white rounded-md border border-slate-200 overflow-hidden",
              divClasses
            )}
          >
            {iconPosition === "left" && (
            ...
            <Combobox.Input
              ...
              className={classNames(
                "!border-0 w-full !ring-0 bg-transparent text-black text-base font-medium px-3",
                inputClasses
              )}
          ...
          >
            <Combobox.Options
              className={classNames(
                "w-full origin-top-right bg-white border-0 divide-y divide-magenta-50 rounded-md shadow ring-0 overflow-auto scroll-smooth scrollbar",
                dropdownClass
              )}
            >
