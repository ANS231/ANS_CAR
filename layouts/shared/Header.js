...
const Header = () => {
  ...
  const userMenu = {
    ...
    menuData: [
      {
        label: "Account",
        icon: "fa-user-large text-magenta-500",
        link: "/user/account",
        standout: false,
      },
      {
        label: "Settings",
        icon: "fa-sliders text-magenta-500",
        link: "/user/settings",
        standout: false,
      },
      {
        label: "My Booking",
        icon: "fa-party-horn text-magenta-500",
        link: "/user/bookings",
        standout: false,
      },
      {
        label: "Transactions",
        icon: "fa-coins text-magenta-500",
    ...
    data: [
      {
        ...
        image: UserImage1,
        content:
          "<strong>Lorem ipsum</strong> dolor sit amet, consectetur adipiscing elit. <strong>Proin lacinia</strong> lorem sit amet ipsum aliquet, eget auctor erat pretium. Aliquam tristique",
        date: "9 Nov, 2023",
        link: "/",
        isRead: false,
      },
                      ...
                      <Link
                        ...
                        className={classNames(
                          ...
                          pathname === item.link
                            ...
                            : "text-white",
                          pathname.includes("/user")
                            ? "!text-black hover:!text-magenta-500"
                            : ""
                        )}
                      >
                        <i
                          className={classNames("fa-regular fa-fw", item.icon)}
                        ></i>
